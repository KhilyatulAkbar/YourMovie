...
public class PopularAdapter extends RecyclerView.Adapter<PopularAdapter.MyViewHolder> {
    ...
    ArrayList<Popular> nowList;
    IDataAdapter mIDataAdapter;
    Context context;

    public PopularAdapter(Context context, ArrayList<Popular> nowList) {
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        Popular list = nowList.get(position);
...
//            tvDate = (TextView) itemView.findViewById(R.id.textViewNowDate);
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Popular now = nowList.get(getAdapterPosition());
            ...
            ibButton.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Popular nowPlaying = nowList.get(getAdapterPosition());
