...
public class NowAdapter extends RecyclerView.Adapter<NowAdapter.MyViewHolder> {
    ...
    ArrayList<Now> nowList;
    IDataAdapter mIDataAdapter;
    Context context;

    public NowAdapter(Context context, ArrayList<Now> nowList) {
    ...
    @Override
    public void onBindViewHolder(NowAdapter.MyViewHolder holder, int position) {
        Now list = nowList.get(position);
...
//            tvDate = (TextView) itemView.findViewById(R.id.textViewNowDate);
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Now now = nowList.get(getAdapterPosition());
            ...
            ibButton.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Now nowPlaying = nowList.get(getAdapterPosition());
